...
class BuildConfigValidator:
    ...
    def __init__(self):
        self.required_files = ["src/main.py", "requirements.txt", "README.md"]
        ...
        for file_path in self.recommended_files:
            ...
            if full_path.exists():
                ...
                results["warnings"].append(
                    f"File direkomendasikan tidak ditemukan: {file_path}"
                )
        ...
        for file_path in self.best_practices:
            ...
            if full_path.exists():
                ...
                results["recommendations"].append(
                    f"Best practice: tambahkan {file_path}"
                )
    ...
    def _validate_entry_point(self, project_path: Path, results: Dict):
        ...
        try:
            ...
            if "def main():" in content or "def main(" in content:
                ...
                results["warnings"].append(
                    "Main function tidak ditemukan di src/main.py"
                )
            ...
            if 'if __name__ == "__main__":' in content:
                ...
                results["warnings"].append(
                    "Entry point guard tidak ditemukan di src/main.py"
                )
        ...
        for node in ast.walk(tree):
            ...
            if isinstance(node, ast.FunctionDef) and node.name == "main":
                ...
                if ast.get_docstring(node):
                    ...
                    results["recommendations"].append(
                        "Tambahkan docstring di main function"
                    )
    ...
    def _check_patterns(self, content: str, results: Dict):
        ...
        # Check untuk imports
        if not re.search(r"^import\s+\w+", content, re.MULTILINE) and not re.search(
        ...
        if "try:" in content and "except:" in content:
            ...
            results["recommendations"].append(
                "Pertimbangkan menambahkan error handling"
            )

    def generate_project_structure(
        self, project_path: str, project_type: str = "standard"
    ) -> bool:
        """
        ...
        try:
            ...
            directories = ["src", "tests", "docs", "config", "resources"]
